...
![Trilho de Ar](https://raw.githubusercontent.com/labremotodeivid-coder/labremoto/main/morango.png)
...
A posição de um corpo em movimento uniformemente variado é dada por:
...
- **θ** = ângulo de inclinação do trilho
...
No trilho inclinado com ângulo **θ**, as forças que atuam no carrinho são:

| Força | Símbolo | Direção |
|-------|---------|---------|
| Peso | mg | Vertical ↓ |
| Normal | N | Perpendicular ao trilho |
| Componente paralela | mg·sen(θ) | Ao longo do trilho |
...
Comparando com o valor teórico **a = g·sen(θ)**, avalia-se a qualidade do experimento.
